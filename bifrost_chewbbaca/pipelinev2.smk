...
rule blast_gene_call:
    ...
    params:
        ...
        chewbbaca_blastdb = f"{os.path.join(os.path.dirname(workflow.snakefile), f'all_{species_sp}_loci.fa')}",
	#chewbbaca_blastdb = f"{os.path.join(os.path.dirname(workflow.snakefile), 'all_{species_sp}_loci.fa')}",
    output:
